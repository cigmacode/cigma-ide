...
function EditPointer({ direction, ...shape }) {
  ...
  switch (direction) {
    case directions.N:
      position.top = shape.top - shape.top - 50;
    ...
    case directions.E:
      ...
      break;
    case directions.S:
      position.top = shape.height - pointerHalfWidth - 50;
      position.left = shape.width / 2 - pointerHalfWidth;
      position.cursor = "ns-resize";
      break;
    case directions.W:
  ...
  return (
    <div ref={pointerRef} style={pointerStyle} draggable={false} data-testid="edit-pointer"></div>
  );
}
